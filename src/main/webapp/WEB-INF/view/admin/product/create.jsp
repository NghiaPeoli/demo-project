                                            ...
                                            <form:form method="post" action="/admin/product/create" class="row"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="target">
                                                        ...
                                                        <form:option value="CAOCAP">Cao cấp, hiệu năng mạnh
                                                        </form:option>
                                                        <form:option value="GIARE-CAUHINHMANH">Giá rẻ - Cấu hình mạnh
                                                        </form:option>
                                                        <form:option value="THIETKETHOITRANG">Camera, thiết kế thời
                                                            trang</form:option>
                                                    </form:select>
                                                </div>
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <input class="form-control" type="file" id="avatarFile"
                                                        accept=".png, .jpg, .jpeg" name="projectFile" />
                                                </div>
